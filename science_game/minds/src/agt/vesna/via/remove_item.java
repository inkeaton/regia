...
/**
 * Internal action to remove an item from the player's inventory.
 *
 * <p>Sends a "remove_item" command to the Godot environment via VesnaManager.</p>
 */
public class remove_item extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        if (args.length < 1) {
            throw new JasonException("vesna.remove_item requires a string argument representing the item name.");
        }
