// ============================================
// == Role: Officer in Plot: Investigation ==
// ============================================
...
+!add_playbook(Name)[source(Sender)] <-
    .print("[Officer] Added playbook ", Name, " from ", Sender);
    +playbook_active(Name, Sender).

+!remove_playbook(Name)[source(Sender)] <-
    .print("[Officer] Removed playbook ", Name, " from ", Sender);
    -playbook_active(Name, Sender).
...
+!signal_directors(PbName, Payload) <-
    .print("[Officer] Signaling directors of ", PbName, " with ", Payload);
