// ============================================
// == Role: Challenger in Plot: HonorDuel ==
// ============================================
...
+!add_playbook(Name)[source(Sender)] <-
    .print("[Challenger] Added playbook ", Name, " from ", Sender);
    +playbook_active(Name, Sender).

+!remove_playbook(Name)[source(Sender)] <-
    .print("[Challenger] Removed playbook ", Name, " from ", Sender);
    -playbook_active(Name, Sender).
...
+!signal_directors(PbName, Payload) <-
    .print("[Challenger] Signaling directors of ", PbName, " with ", Payload);
