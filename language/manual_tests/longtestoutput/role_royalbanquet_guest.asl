// ============================================
// == Role: Guest in Plot: RoyalBanquet ==
// ============================================
...
+!add_playbook(Name)[source(Sender)] <-
    .print("[Guest] Added playbook ", Name, " from ", Sender);
    +playbook_active(Name, Sender).

+!remove_playbook(Name)[source(Sender)] <-
    .print("[Guest] Removed playbook ", Name, " from ", Sender);
    -playbook_active(Name, Sender).
...
+!signal_directors(PbName, Payload) <-
    .print("[Guest] Signaling directors of ", PbName, " with ", Payload);
